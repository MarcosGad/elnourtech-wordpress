 ...
 * Copyright 2016-2020 VillaTheme.com. All rights reserved.
...
define( 'VI_WNOTIFICATION_F_VERSION', '1.2.3.5' );
/**
	...
	function global_note() {
		if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
            ...
            <div id="message" class="error">
                <p><?php _e( 'Please install and activate WooCommerce to use Notification for WooCommerce plugin.', 'woo-notification' ); ?></p>
            </div>
			<?php
		}
	}
