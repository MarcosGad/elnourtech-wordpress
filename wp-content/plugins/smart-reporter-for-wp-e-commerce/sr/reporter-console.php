    ...
    if(  $wpdb->get_var("SHOW TABLES LIKE '$table_name'") != $table_name
        ...
        ?>
            ...
            <div id="sr_data_sync_msg" class="updated woocommerce-message wc-connect" style="margin-top:25%;text-align:center;border:0px;display: block!important;">
              ...
              <div class="submit" style="padding:0;"> <a id="sr_sync_link" href="<?php echo esc_url( add_query_arg( 'sr_data_sync', 'true', admin_url( 'admin.php?page=wc-reports&tab=smart_reporter'.$redirect_view ) ) ); ?>" class="wc-update-now button-primary"><?php _e( 'Sync Now', $sr_text_domain ); ?></a> </div> 
...
// ================================================
 -->
    ...
    // ================================================
     -->
     <div id="sr_cumm_small_widget_coupons" class="sr_cumm_small_widget_parent" style="height: 24.8em;">
...
function smart_reporter_footer() {
    ...
    if ( !$sr_admin_footer ) {
      ...
      <div id="sr_putler_promotion" class="sr_promotion_footer">
          <?php echo __(" For more Extensive Reporting use ", $sr_text_domain); ?> <a href="https://www.putler.com/?&utm_source=SR_IN_WP" target="_blank"> <?php echo __('Putler', $sr_text_domain); ?></a> 
      </div>
